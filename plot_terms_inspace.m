...
plot_worldmap_viewer_gender(dictionary_corrected_bigrams(term),data_final_corrected(:,term),covariates.final_authors_gender,covariates.final_authors_country)
if (save_derivatives==1)
image_filename = strcat('derivatives/litemo_inspace/',dictionary_corrected(term),'.png');
