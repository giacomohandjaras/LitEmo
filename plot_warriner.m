...
DATA=load('ALL_TERMS/all_terms_010_10000perm_light_v20220112.mat','dictionary_corrected','covariates','data_final_corrected','results_cohen_d_gender_corrected');
...
image_filename = strcat('derivatives/plot_warriner_',effect_of_interest,'_ratings.png');
...
if (save_derivatives==1)
image_filename = strcat('derivatives/plot_warriner_',effect_of_interest,'.png');
export_fig(image_filename,'-m12','-nocrop', '-transparent','-silent');
end
